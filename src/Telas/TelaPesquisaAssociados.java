 ...
 * @author info48
 */
public class TelaPesquisaAssociados extends javax.swing.JDialog {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
     ...
     //File testa = new File("associados.db"); 
     //if (testa.exists()){ 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaAssociados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
